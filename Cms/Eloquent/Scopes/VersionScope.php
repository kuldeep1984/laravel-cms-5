...
/**
 * Description of VersionScope
 *
 * @author user
 */
class VersionScope implements ScopeInterface{
	...
	public function apply(Builder $builder, Model $model)
	{
		...
		$column = $model->getQualifiedVersionColumn();
	...
	public function remove(Builder $builder, Model $model)
	{
		...
		{
			if ($this->isVersionConstraint($where, $column))
			{
	 ...
	 * @return boolean
	 */
	protected function isVersionConstraint(array $where, $column)
	{
		return ($where['type'] == 'Basic' && $where['column'] == $column && $where['value'] == ['Cms']);
	}
