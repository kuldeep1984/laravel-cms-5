...
(function (m) {
    ...
    function e(o) {
        function p(s) {
            ...
            r.appendChild(t);
            return o.selection.serializer.serialize(r, {
                format: "html"
            })
        }
        function q(r) {
    ...
    a.html.SaxParser = function (c, e) {
        ...
        b.parse = function (D) {
            var n = this,
                g, F = 0,
                H, A, z = [],
                M, P, B, q, y, r, L, G, N, u, m, k, s, Q, o, O, E, R, K, f, I, l, C, J, h, v = 0,
...
(function (b) {
    ...
    b.html.DomParser = function (g, h) {
        ...
        f.parse = function (v, m) {
            var n, H, A, z, C, B, x, r, E, L, y, o, D, K = [],
                J, t, k, s, p, u, q;
            m = m || {};
            i = {};
            c = {};
...
(function (e) {
    ...
    e.create("tinymce.dom.DOMUtils", {
        ...
        getSize: function (l) {
            ...
            return {
                w: parseInt(i) || l.offsetWidth || l.clientWidth,
                h: parseInt(k) || l.offsetHeight || l.clientHeight
            }
        },
    ...
    n.create("tinymce.Editor", {
        Editor: function (u, r) {
            ...
            q.settings = r = f({
                ...
                custom_undo_redo: 1,
                doctype: n.isIE6 ? '<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">' : "<!DOCTYPE>",
                        ...
                        if (t.charAt(0) == "-") {
                            ...
                            i(s, function (A) {
                                var z = {
                                    prefix: "plugins/",
                                    resource: A,
                                    suffix: "/editor_plugin" + n.suffix + ".js"
                                };
        ...
        init: function () {
            ...
            function C(K) {
                var L = c.get(K),
                    t = c.urls[K] || n.documentBaseURL.replace(/\/$/, ""),
                    s;
        ...
        getParam: function (x, s, q) {
            var t = n.trim,
                r = d(this.settings[x]) ? this.settings[x] : s,
                u;
            if (q === "hash") {
                u = {};
                if (d(r, "string")) {
    ...
    j.create("tinymce.ForceBlocks", {
        ...
        setup: function () {
            var l = this,
                ...
                q = k.dom,
                m = k.selection,
                o = k.schema.getBlockElements();
            if (n.forced_root_block) {
                function r() {
                    var v = m.getStart(),
                        t = k.getBody(),
                        s, x, B, D, C, u, y, z = -16777215;
                    if (!v || v.nodeType !== 1) {
                        return
                    }
                    while (v != t) {
            ...
            if (j.isWebKit) {
                function p(t) {
                    var s = m.getRng(),
                        u, y = q.create("div", null, " "),
                        x, v = q.getViewPort(t.getWin()).h;
...
(function (a) {
    a.Formatter = function (W) {
        var N = {},
            ...
            q = W.selection,
            t = a.dom.TreeWalker,
            L = new a.dom.RangeUtils(c),
            d = W.schema.isValidChild,
            G = c.isBlock,
            l = W.settings.forced_root_block,
            s = c.nodeIndex,
            F = a.isGecko ? "\u200B" : "\uFEFF",
            e = /^(src|href|style)$/,
            T = false,
        ...
        function B(Z, ai, ab) {
            ...
            function ae(ao) {
                var an = c.get(ao ? "_start" : "_end"),
                    am = an[ao ? "firstChild" : "lastChild"];
                if (I(am)) {
        ...
        function o(X, ai, aa) {
            var al, aj, ad, Z = X.startContainer,
                ae = X.startOffset,
                an = X.endContainer,
                ag = X.endOffset,
                al, aj, ad, ah;
        ...
        function R(ag, X, ae) {
            ...
            function ai() {
                var aj = q.getRng(true),
                    ak, am, ap, ao, al, at, ar = [],
                    an, aq;
