                    ...
                    {!! Form::open(['method' => 'POST','route'=>['users.store']]) !!}
                        ...
                        <TABLE cellSpacing=2 cellPadding=4 width="93%" align=center border=0>
                            ...
                            <tr>
                                ...
                                <td width="30%" align="left" ><input type="text" name="txt_empcode" id="txt_empcode" value="{{Request::old('txt_empcode')}}" style="width:220px;"></td>

                            </tr>
                            <tr><td colspan='2'>&nbsp;</td></tr>
                            <tr>
                                <td width="20%" align="right" >*Contact Name : </td>
                                <td width="30%" align="left" ><input type="text" name="txt_name" id="txt_name" value="{{Request::old('txt_name')}}" style="width:220px;"></td>

                            </tr>
                            <tr><td colspan='2'>&nbsp;</td></tr>
                            <tr>
                                <td width="20%" align="right" >*Email Address : </td>
                                <td width="30%" align="left"><input type="text" name="txt_email" id="txt_email" value="{{Request::old('txt_email')}}" style="width:220px;"></td>
                            </tr>
                            <tr><td colspan='2'>&nbsp;</td></tr>
                            <tr>
                                <td width="20%" align="right" valign="top">*Mobile No. : </td>
                                <td width="30%" align="left" ><input type="text" name="txt_mobile" id="txt_mobile" value="{{Request::old('txt_mobile')}}" style="width:220px;"></td>

                            </tr>
                            <tr><td colspan='2'>&nbsp;</td></tr>
                            <tr>
                                <td width="20%" align="right" >*UserName : </td>
                                <td width="30%" align="left" ><input type="text" name="txt_username" id="txt_username" value="{{Request::old('txt_username')}}" style="width:220px;"></td>
                            ...
                            <tr>
                                ...
                                <td width="30%" align="left"><input type="password" name="txt_password" id="txt_password" value="{{Request::old('txt_password')}}" style="width:220px;">
                            ...
                            <tr>
                                ...
                                <td width="30%" align="left" >
                                    ...
                                    <select name="region"  id="region" class="field" style="width:222px;" onchange="selectedCityByRegion(this.value)">
                                        ...
                                        <option value='{{$k}}' @if(Request::old('region') == $k) selected @endif>{{$v}}</option>
                                        @endforeach
                            ...
                            <tr>
                                ...
                                <td width="30%" align="left" >
                                    ...
                                    <select name="dept" id="dept" style="width:222px;" onchange="showHideCity(this.value);">
                                        ...
                                        <option value ='{{$k}}' @if(Request::old('dept') == $k)selected @endif>{{$v}}</option>
                                        @endforeach
                            ...
                            <tr>
                                ...
                                <td width="30%" align="left" >
                                    ...
                                    <select name="department"  id="department" class="field" style="width:222px;" onchange="showHideCity($('#dept').val());
                                        ...
                                        <option value ='{{$k}}' @if(Request::old('department') == $k) selected @endif>{{$v}}</option>
                                        @endforeach
                                    </select>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td width="30%" align="left" >
                                    ...
                                    <select name="manager_id"  id="manager_id" class="field" style="width:222px;">
                                        ...
                                        <option  value ='{{$k}}' @if(Request::old('manager_id') == $k) selected @endif>{{$v}}</option>
                                        @endforeach
                                    </select>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td width="30%" align="left" >
                                    <input name="joiningdate"  type="text" class="formstyle2" id="joiningdate"  value="{{Request::old('joiningdate')}}" size="8" readonly style="width:200px">  <img src="{{URL::asset('images/cal_1.jpg')}}" id="f_trigger_start" style="cursor: pointer; border: 1px solid red;" title="Date selector" onMouseOver="this.style.background = 'red';" onMouseOut="this.style.background = ''" />
                                </td>
                            ...
                            <tr>
                                ...
                                <td width="30%" align="left" ><input name="resignationdate"  type="text" class="formstyle2" id="resignationdate"  value="{{Request::old('resignationdate')}}" size="8" readonly style="width:200px">  <img src="{{URL::asset('images/cal_1.jpg')}}" id="f_trigger_end" style="cursor: pointer; border: 1px solid red;" title="Date selector" onMouseOver="this.style.background = 'red';" onMouseOut="this.style.background = ''" />
                                </td>
                            </tr>
                            ...
                            <tr style="dispaly:none" class="pt_changestatus">
                                ...
                                <td width="30%" align="left">
                                    ...
                                    <input type="radio" name="active" id="activebtn" value="Y" @if(Request::old('active') == 'Y') checked @endif >&nbsp;Active &nbsp;&nbsp;
                                           <input type="radio" name="active" id="unactivebtn" value="N" @if(Request::old('active') == 'N') checked @endif >&nbsp;Deactive
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td width="30%" align="left" >
                                    <input type="text" name="cloudAgentId" id="cloudAgentId" value="{{Request::old('cloudAgentId')}}" style="width:220px;"></td>
                                <td width="50%" align="left"></td>
                            </tr>
                            <tr><td colspan='2'>&nbsp;</td></tr>
                            <tr>
...
//function for show hide department only display city list when department is survey    
    $(document).ready(function () {
        var role = "{{Request::old('department')}}";
        var department = "{{Request::old('dept')}}";
